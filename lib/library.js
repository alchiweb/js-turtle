...
//This is adapdet version for TUMO
...
// drawn graphics.
var imageCanvas = document.getElementById("imagecanvas"); // $('#imagecanvas')[0];
var imageContext = imageCanvas.getContext('2d');
var turtleCanvas = document.getElementById("turtlecanvas"); //$('#turtlecanvas')[0];
...
canv.addEventListener('click', function(e) {  // use event argument
   ...
   canvasX = coords.x;
   canvasY = coords.y;
   co.innerHTML = "X:" + (canvasX-700/2) + "<br>Y:" + (-canvasY+700/2);
   co.innerHTML+= "<br>(" + (canvasX-700/2) + "," + (-canvasY+700/2)+")";
});

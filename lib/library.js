//Initial version see at http://berniepope.id.au/html/js-turtle/turtle.html
...
function forward(distance, step = false) {
    if (stepByStep && !step) {
...
function color(sr, sg, sb, step = false) {
    if (Array.isArray(sr)) {
        r = sr[0];
        g = sr[1];
        b = sr[2];
...
function right(angle, step = false) {
    if (stepByStep && !step) {
...
function left(angle, step = false) {
    if (stepByStep && !step) {
...
function angle(_angle, step = false) {
    if (stepByStep && !step) {
